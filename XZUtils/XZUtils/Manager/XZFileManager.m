...
#import "XZFileManager.h"
#import <ImageIO/ImageIO.h>
#import <sys/xattr.h>

@implementation XZFileManager
...
{
    return [[XZFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XZFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XZFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XZFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XZFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XZFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
